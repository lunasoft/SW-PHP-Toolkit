...
class Certificados{
	...
	function pareja($nombreCerPem = null, $nombreKeyPem = null){
        ...
        function  certificadoBase64($nombreCer = null){
            if($nombreCer == null){
			if($this->_cer != null){
				$nombreCer = $this->_cer;
			}else {
